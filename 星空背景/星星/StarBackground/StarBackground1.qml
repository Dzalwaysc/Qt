...
Item {
    ...
    property int starsamount: 50  // 星星的数量
    property int starsradius: 60    // 星星半径比
    property int movrange: 2        // 星星移动范围（值越大范围越小）
    property int speed: 50000       // 星星移动速度（值越大速度越慢）
    ...
    Canvas{
        ...
        onPaint: {
            ...
            var Star = function() {
                // 至画布中心的距离
                this.orbitRadius = random(maxOrbit(mW, mH));
                // 星星的半径
                this.radius = random(starsradius, this.orbitRadius);
